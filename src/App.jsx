...
<a
  href="https://www.facebook.com/Polnex.dev/"
  target="_blank"
  rel="noreferrer"
  className="fixed bottom-28 right-6 z-[999] flex items-center bg-zinc-950 border border-[#1877F2] gap-3 rounded-full bg-zinc-950 px-5 py-4 text-white shadow-[0_0_40px_rgba(24,119,242,0.45)] transition duration-300 hover:scale-110 hover:bg-[#1877F2] hover:shadow-[0_0_45px_rgba(24,119,242,0.45)]"
>
  <svg
...
>
  ...
  target="_blank"
  rel="noreferrer"
  className="group fixed bottom-6 right-6 z-[999] flex items-center gap-3 rounded-full border border-[#25D366] bg-zinc-950 px-5 py-4 text-white shadow-[0_0_40px_rgba(37,211,102,0.35)] transition-all duration-300 hover:bg-[#25D366] hover:scale-110 hover:shadow-[0_0_50px_rgba(37,211,102,0.55)]"
>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    className="h-7 w-7 text-[#25D366] fill-current transition-all duration-300 group-hover:text-white"
  >
 ...
 <span className="hidden lg:block font-black text-[#25D366] transition-all duration-300 group-hover:text-white">
  WhatsApp
</span>
</a>
    </div>
